...
import { STAFF_UNREAD_COUNT } from "@/lib/staff-dashboard-config";

const NOTIFICATIONS = [
  {
    id: 1,
    type: "result",
    title: "Results Submitted — SS 2 Physics",
    body: "Your CA and exam scores for SS 2 Physics have been submitted for approval.",
    time: "10 min ago",
    read: false,
  },
  {
    ...
    body: "You haven't submitted attendance for SS 1 today. Please mark attendance before 2:00 PM.",
    time: "1 hr ago",
    read: false,
  },
  {
    ...
    body: "All staff are required to attend the general meeting this Friday at 10:00 AM in the auditorium.",
    time: "3 hrs ago",
    read: false,
  },
  {
    id: 4,
    type: "message",
    title: "New Message from Mr. Richard Doe",
    body: "Good afternoon Ma, I wanted to follow up on John's performance in Physics...",
    time: "Yesterday",
    read: false,
  },
  {
    ...
    body: "The timetable module has been updated with new features.",
    time: "2 days ago",
    read: true,
  },
];
...
export function StaffNotificationDropdown() {
