...
const MINI_NOTIFICATIONS = [
  { id: 1, title: "PTA Meeting Rescheduled", body: "The PTA meeting has been moved to next week Friday.", time: "2h ago", read: false },
  { id: 2, title: "CA Test 1 Scheduled", body: "First CA test starts next Monday. Check timetable.", time: "5h ago", read: false },
  { id: 3, title: "Library Hours Extended", body: "Library now open until 5 PM on weekdays.", time: "1d ago", read: true },
  { id: 4, title: "School Fees Reminder", body: "Outstanding fees should be cleared before exams.", time: "2d ago", read: true },
];
